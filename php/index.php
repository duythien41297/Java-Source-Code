	...
	<div id="fh5co-page">
		...
		<aside id="fh5co-aside" role="complementary" class="border js-fullheight">
			...
			<div class="fh5co-footer">
				<p><small>&copy; 2019 HUTECH. All Rights Reserved.</span> <span>Re-Designed by OK <a href="http://freehtml5.co/" target="_blank">FreeHTML5.co</a> </span> <span>Demo Images: <a href="http://pexels.com/" target="_blank">Pexels</a></span></small></p>
				<ul>
		...
		<div id="fh5co-main">
			<div class="fh5co-gallery">
				...
				<a class="gallery-item" href="contact.php">
			...
			<h2 style="font-family:Arial;font-size: 30px;padding-left: 20px"> Advertisement</h2>
			<div class="fh5co-gallery">
