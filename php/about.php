	...
	<div id="fh5co-page">
		...
		<div id="fh5co-main">
			...
			<div class="fh5co-narrow-content">
                ...
                {
                    case "xuat_san_pham":
                        include("chucnang/sanpham/xuatsp.php");
                    break;
                    case "chi_tiet_san_pham":
                        include("chucnang/sanpham/chitietsanpham.php");
                    break;
                    case "xuat_san_pham_2":
                        include("chucnang/sanpham/xuattoanbo.php");
                    break;
                    case "xuat_mot_tin":
                        include("chucnang/sanpham/xuatmottin.php");
                    break;
                    case "tim_kiem":
                        include("chucnang/timkiem/xuattimkiem.php");
                    break;
                    case "gio_hang":
                    ...
                    default:
                        ...
                        include("chucnang/sanpham/spnoibat.php");
                        include("chucnang/sanpham/xuatspchuot.php");
                        include("chucnang/sanpham/xuatspPC.php");
                        include("chucnang/sanpham/xuatSoftware.php");
